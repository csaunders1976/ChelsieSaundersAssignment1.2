...
class Api extends CI_Controller
{
    ...
    public function register()
    {
        ...
        $this->form_validation->set_rules('firstname', 'Firstname', 'required|min_length[2]|max_length[35]');
        $this->form_validation->set_rules('lastname', 'Lastname', 'required|min_length[2]|max_length[35]');
